...
Відкрий браузер і перейди на `http://localhost:8086` або `http://192.168.Х.Х:8086` (ір 192.168.Х.Х дізнатися у викладача) якщо ви знаходитесь в самій машині. Ти побачиш папку «Вхідні» з листом позначеним як **⚠ ПІДОЗРІЛИЙ**.
