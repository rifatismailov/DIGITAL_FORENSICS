...
- Якщо ви підключаєтесь віддалено — використовуйте IP-адресу машини: http://192.168.88.38:8086
...
Відкрий браузер і перейди на `http://localhost:8086` якщо ви знаходитесь в самій машині або `http://192.168.88.38:8086` (ір 192.168.Х.Х дізнатися у викладача). Ти побачиш папку «Вхідні» з листом позначеним як **⚠ ПІДОЗРІЛИЙ**.
